...
const { authorize, authorizeOrSelf } = require('../middleware/auth');
const {
  getAllUsers,
  getUserById,
  createUser,
...
// PUT /users/:id - admin/manager can update any user; regular user can only update themselves
router.put('/:id', authorizeOrSelf('admin', 'manager'), updateUser);
